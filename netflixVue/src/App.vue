<template>
  <div class="contain">
      ...
      <category v-for="category in categories" v-bind:key="category.id" v-bind:movies="category.movies" v-bind:p-title="category.title"></category>
